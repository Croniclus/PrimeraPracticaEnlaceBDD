...
public class TestConexion {
	public static void main(String[] args) {
		...
		try {
			cn = conexion.conectar();
			PreparedStatement stm2 = cn.prepareStatement("INSERT INTO usuarios(PrimerNombre,SegundoNombre,Pais,E-mail,Password,Re-enterPassword) VALUES (?,?,?,?,?,?)");
			stm2.setString(1 , "David");
			stm2.setString(2 , "Ramirez");
			stm2.setString(3 , "España");
			stm2.setString(4, "davidramirezguirado2004@gmai.com");
			stm2.setString(5, "Password");
			stm2.setString(6, "Re-enterPassword");
